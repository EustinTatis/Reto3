...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Button boton1 = (Button) getView().findViewById(R.id.boton1);
...

    {
        ...
        Snackbar snackbar = Snackbar.make(linearLayout, "El día de hoy no tenemos promociones.", Snackbar.LENGTH_LONG);
        snackbar.show();
    }
    });
}
